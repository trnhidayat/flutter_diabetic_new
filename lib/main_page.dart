...
import 'package:flutter_diabetic/item_card.dart';
        ...
        children: <Widget>[
          ...
          Center(
            child: ElevatedButton(
              child: Text('Take picture for your food'),
              onPressed: () {
                Navigator.push(
                  context,
                        ...
                        child: Column(
                          ...
                          children: [
                            TextField(
                              ...
                              decoration: InputDecoration(hintText: "Glucose Level"),
                            ),
                            TextField(
                              style: GoogleFonts.poppins(),
                              controller: carboController,
                              decoration: InputDecoration(hintText: "Carbohydrate Intake"),
